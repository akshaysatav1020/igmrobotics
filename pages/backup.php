...
<body>
  ...
  <div class="container-fluid" >
    <div class="row">
      <main>
          ...
          <label for="tab1">Euro rate</label>
          <input id="tab2" type="radio" name="tabs">
          <label for="tab2">Ware House</label>          
          ...
          <section id="content1">
            <form  method="GET" name="euro">
              <div class="col-md-3">
                <div class="form-group">
                  <label for="description">Euro Rate &euro;</label>
                  <input type="text" class="form-control number" maxlength="6" name="eurorate" required="required"/>
                </div>
              </div>
              <div class="col-md-4" style="padding:2%;">
                <div class="form-group">
                    <button type="button" class="btn btn-md btn-warning" onclick="updateRate()" name="updaterate">Update Rate</button>
                </div>
              </div>
           </form>
          </section>
          <section id="content2">
            <form method="GET" name="warehouse">              
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Rack</label>
                  <input type="text" class="form-control" maxlength="2" name="rack" required="required"/>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Floor</label>
                  <input type="text" class="form-control" maxlength="2" name="floor" required="required"/>
                </div>
              </div>
              <div class="col-md-4" style="padding:2%;">
                <div class="form-group">
                    <button type="button" class="btn btn-md btn-warning" onCLick="updateWarehouse()" name="updatewarehouse">Update Warehouse</button>
                </div>
              </div>
           </form>
          </section>
          ...
          <section id="content5">
            <form action="../php/backup.php" method="POST">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Quotation Counter</label>
                  <input type="text" class="form-control" name="pocounter" required="required"/>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Invoice Counter</label>
                  <input type="text" class="form-control" name="pocounter" required="required"/>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Purchase Order Counter</label>
                  <input type="text" class="form-control" name="pocounter" required="required"/>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Challan Counter</label>
                  <input type="text" class="form-control" name="pocounter" required="required"/>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Credit Note Counter</label>
                  <input type="text" class="form-control" name="pocounter" required="required"/>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="description">Debit Note Counter</label>
                  <input type="text" class="form-control" name="pocounter" required="required"/>
                </div>
              </div>
              <button type="submit" class="btn btn-md btn-success" name="export">Update Counter</button>
            </form> 
          </section>
          <section id="content6">
            <!-- <form action="../../../php/dataSettings.php" method="POST" name="password"> -->
  ...
  function getAllDetails(){
    $.ajax({
      method:"POST",
      type:"json",
      data:{"getAllDetails":"getAllDetails"},
      url:"../php/dataSettings.php",
      success:function(data){
        //console.log(data);
        if(data!=""){
          $("input[name='eurorate']").val(JSON.parse(data).rate);
          $("input[name='rack']").val(JSON.parse(data).rack);
          $("input[name='floor']").val(JSON.parse(data).floor);
  ...
  function updateWarehouse(){
    $.ajax({
      method:"POST",
      type:"json",
      data:{"rack":$("input[name='rack']").val(),"floor":$("input[name='floor']").val(),"updatewarehouse":"updatewarehouse"},
      url:"../php/dataSettings.php",
      success:function(data){
        console.log(data);  
        if(data=="Updated"){
  ...
  function updateRate(){
    $.ajax({
      method:"POST",
      type:"json",
      data:{"eurorate":$("input[name='eurorate']").val(),"updaterate":"updaterate"},
      url:"../php/dataSettings.php",
      success:function(data){
        console.log(data);
        if(data=="Updated"){
